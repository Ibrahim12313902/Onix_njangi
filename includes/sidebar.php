...
<div class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-menu">
        <ul>
            ...
            <li>
                <a href="<?php echo SITE_URL; ?>members/index.php" class="<?php echo isActive('', 'members'); ?>">
                    <i class="fas fa-users"></i> Members
                </a>
            </li>

            <li>
                <a href="<?php echo SITE_URL; ?>member_types/index.php" class="<?php echo isActive('', 'member_types'); ?>">
                    <i class="fas fa-user-tag"></i> Member Type
                </a>
            </li>

            <li>
                <a href="<?php echo SITE_URL; ?>hand_types/index.php" class="<?php echo isActive('', 'hand_types'); ?>">
                    <i class="fas fa-hand-holding"></i> Hand Types
                </a>
            </li>

            <li>
                <a href="<?php echo SITE_URL; ?>hands/index.php" class="<?php echo isActive('', 'hands'); ?>">
                    <i class="fas fa-hands-helping"></i> Hands
                </a>
            </li>

            <li>
                <a href="<?php echo SITE_URL; ?>hand_requests/index.php" class="<?php echo isActive('', 'hand_requests'); ?>">
                    <i class="fas fa-clipboard-list"></i> Hand Requests
                </a>
            </li>

            <li>
                <a href="<?php echo SITE_URL; ?>hand_status/index.php" class="<?php echo isActive('', 'hand_status'); ?>">
                    <i class="fas fa-clipboard-check"></i> Hand Status
                </a>
            </li>

            <li>
                <a href="<?php echo SITE_URL; ?>payout_cycles/index.php" class="<?php echo isActive('', 'payout_cycles'); ?>">
                    <i class="fas fa-calendar-alt"></i> Payout Cycles
                </a>
            </li>

            <li>
                <a href="<?php echo SITE_URL; ?>payout_management/index.php" class="<?php echo isActive('', 'payout_management'); ?>">
                    <i class="fas fa-gift"></i> Payout Management
                </a>
            </li>

            <li>
                <a href="<?php echo SITE_URL; ?>payment_proofs/index.php" class="<?php echo isActive('', 'payment_proofs'); ?>">
                    <i class="fas fa-file-invoice"></i> Payment Proofs
                </a>
            </li>

            <li>
                <a href="<?php echo SITE_URL; ?>announcements/index.php" class="<?php echo isActive('', 'announcements'); ?>">
                    <i class="fas fa-bullhorn"></i> Announcements
                </a>
            </li>

            <li>
                <a href="<?php echo SITE_URL; ?>group_chat/index.php" class="<?php echo isActive('', 'group_chat'); ?>">
